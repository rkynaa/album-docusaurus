...
<Tabs
  ...
  <TabItem value="apple">
    ...
    {/* <OpenApiResponse definitionId="petstore" pointer="../../src/components/responses/album-api-final" /> */}</TabItem>
  <TabItem value="orange">
    ```yml title: "post"
        ...
        responses: #API's response based on code
    ```
    List of responses are [here](/docs/album-api/api-responses#post).</TabItem>
  </Tabs>
